...
+(instancetype)netWorkViewWithViewController:(UIViewController *)vc {
    ...
    ToolNetWorkView *toolNetWorkView = [[[NSBundle mainBundle] loadNibNamed:@"ToolNetWorkView" owner:nil options:nil] firstObject];
...
+(void)showNetWordNotiInViewController:(UIViewController *)vc y:(CGFloat)y{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        CGRect frame=CGRectMake(0, y, vc.view.bounds.size.width, 40.0f);
